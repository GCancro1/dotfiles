return {
	...
	keys = {
		...
		{ "<leader>sg", function() Snacks.picker.grep({ hidden = true, ignored = true }) end, desc = "Grep", },
        ...
        { "<leader>sk", function() Snacks.picker.keymaps({plugs = true}) end, desc = "keymap picker", mode = { "n" }, }, 
